...
class VerificationCodeVerifyAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            verification_code = VerificationCode.objects.get(phone_number=phone_number, device_id=device_id, code=code, code_type=code_type)
        ...
        if verification_code:
            if code_type == "ver":
                ...
                user = get_object_or_404(User, phone_number=phone_number, is_active=True, is_deleted=False, is_verified=True)
